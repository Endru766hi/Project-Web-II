<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <!-- nomor hp -->
            <div>
                <x-input-label for="nomor_hp" :value="__('Nomor_hp')" />
                <x-text-input id="nomor_hp" class="block mt-1 w-full" type="text" name="nomor_hp"  required autofocus autocomplete="new-nomor_hp" />
